...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("副车架台架载荷迭代工具")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "副车架台架载荷迭代工具"))
        ...
        self.pushButton_5.setText(_translate("MainWindow", "导出当前页面数据"))
        self.pushButton_4.setText(_translate("MainWindow", "保存载荷数据"))
        ...
        item.setText(_translate("MainWindow", "HS_Position"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "HS_N"))
