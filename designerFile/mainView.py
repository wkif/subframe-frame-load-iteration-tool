...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Subframe frame load iteration tool", "副车架台架载荷迭代工具"))
        self.pushButton.setText(_translate("Import VRLDA damage data", "导入VRLDA损伤数据"))
        self.pushButton_2.setText(_translate("Import load data", "导入载荷数据"))
        self.pushButton_3.setText(_translate("Import CYCLE damage data", "导入CYCLE损伤数据"))
        self.pushButton_5.setText(_translate("Export current page data", "导出当前页面数据"))
        self.pushButton_4.setText(_translate("Save load data", "保存载荷数据"))
